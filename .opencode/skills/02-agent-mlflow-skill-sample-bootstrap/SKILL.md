...
target_project_path: <workspace>/pytorch_sample
copy_mode: folder
...
복사 전 확인:
python .opencode/scripts/bootstrap_sample_project.py --project <workspace> --sample pytorch

실제 복사:
python .opencode/scripts/bootstrap_sample_project.py --project <workspace> --sample pytorch --execute
